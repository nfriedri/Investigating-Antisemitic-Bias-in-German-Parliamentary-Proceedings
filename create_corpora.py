...
def create_corpora(slicing_criterion):
    """
    param slicing_criterion: either historic or balanced
    """
    ...
    elif slicing_criterion == 'balanced':
...
def main():
    ...
    parser.add_argument("--slicing_criterion", "-s", nargs='?', choices=['historic', 'balanced'],
                        help="Whether to apply historic or balanced slicing", required=True)
    args = parser.parse_args()

    create_corpora(args.slicing_criterion)
